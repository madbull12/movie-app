        ...
        <div className="relative">
          ...
          <div className=' w-[90%] px-2 py-4  -mt-20 text-white backdrop-sepia-0 bg-black/30 rounded-lg mx-auto space-y-2'>
                <div className='flex justify-between items-center'>
                    <h1 className='text-xl font-semibold'>{tvDetails.name}</h1>
                ...
                <p className='font-bold'>Seasons: <span className='font-normal'>{tvDetails.number_of_seasons} seasons</span></p>
                <p className='font-bold'>Episodes: <span className='font-normal'>{tvDetails.number_of_episodes} episodes</span></p>
            
                <div>
                    <p className='font-bold'>Rating: <span className='font-normal'>{tvDetails.vote_average}</span></p>
                </div>
