  ...
  return (
    <div className='pl-6 bg-[#0D0C0F] space-y-8 text-gray-500 ml-[190px] mx-auto max-w-4xl min-h-screen space-y-8'>
      ...
      <div>
        ...
        <div className="row scrollbar scrollbar-thumb-gray-800 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-rounded-md">
          {nowPlayingMovies.map((movie)=>(
              <Poster key={movie.id} movie={movie} size="normal" />
            ))}
        </div>
      </div>
      <div>
